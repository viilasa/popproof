...
-- Service role can insert/update subscriptions
...
INSERT INTO user_subscriptions (user_id, plan_id, status, current_period_start, current_period_end, visitors_used)
SELECT 
    u.id,
