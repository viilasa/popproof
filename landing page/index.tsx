      ...
      <nav className="fixed top-0 w-full z-50 glass-nav">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button className="text-sm font-medium text-slate-900 hover:text-[#3E8BFF] transition-colors">Log in</button>
            <button className="bg-black text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              Get Started
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 absolute w-full p-6 flex flex-col gap-4 shadow-xl">
            ...
            <button className="w-full bg-black text-white py-3 rounded-lg font-medium mt-2">Get Started</button>
          </div>
        )}
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-[#3E8BFF] text-white px-8 py-4 rounded-xl font-medium hover:bg-blue-600 transition-all shadow-[0_4px_14px_0_rgba(62,139,255,0.39)] flex items-center justify-center gap-2 group">
                Get Started <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform"/>
              </button>
              <button className="bg-transparent border border-[#1E1E1E] text-[#1E1E1E] px-8 py-4 rounded-xl font-medium hover:bg-slate-50 transition-all flex items-center justify-center">
                Live Demo
              </button>
            </div>
          ...
          <div className="bg-black rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <button className="bg-[#3E8BFF] text-white px-8 py-4 rounded-xl font-medium hover:bg-blue-600 transition-all shadow-lg text-lg">
                        Create Your Account
                    </button>
                    <button className="bg-transparent border border-slate-700 text-white px-8 py-4 rounded-xl font-medium hover:bg-slate-900 transition-all text-lg">
                        Try Live Demo
                    </button>
                </div>
